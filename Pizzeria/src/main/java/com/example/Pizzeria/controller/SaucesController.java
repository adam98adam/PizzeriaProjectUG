...
public class SaucesController {
    ...
    @PostMapping("/sauces")
    public ResponseEntity<Sauces> saveSauce(@Valid @RequestBody Sauces sauce) {
    ...
    public ResponseEntity<Sauces> updateSauceById(@PathVariable Integer id, @Valid @RequestBody Sauces sauces) {
